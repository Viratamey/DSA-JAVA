...
public class SortAlgo {
    public static void main(String[] args) {
        ...
        selectionsort(arr);
        int[] arr1 = {12,45,78,90,34,13,56,34,39,9,8,30,23,38,11,6,8,2,200,111,154};
        insertionsort(arr);

        arr1 = new int[]{12, 45, 78, 90, 34, 13, 56, 34, 39, 9, 8, 30, 23, 38, 11, 6, 8, 2, 200, 111, 154};
        mergesort(arr);

        int[] arr2 = {12, 45, 78, 90, 34, 13, 56, 34, 39, 9, 8, 30, 23, 38, 11, 6, 8, 2, 200, 111, 154};
        quicksort(arr);
    }
